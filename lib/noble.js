...
function Noble(bindings) {
  ...
  this._bindings.on('cleanUp', this.onConnect.bind(this));
  this._bindings.on('setLoggingPath', this.setLoggingPath.bind(this));
...
Noble.prototype.cleanUp = function () {
  debug(`cleanUp`);
  this._bindings.cleanUp();
};
Noble.prototype.setLoggingPath = function (path) {
  debug(`setLogginPath ${path}`);
  this._bindings.setLoggingPath(path);
};
  ...
  const scan = function (state) {
    if (state !== 'poweredOn') {
      const error = new Error(
        `Could not start scanning, state is ${state} (not poweredOn)`
      );
...
Noble.prototype.startScanningAsync = function (serviceUUIDs, allowDuplicates) {
  return util.promisify((callback) =>
    this.startScanning(serviceUUIDs, allowDuplicates, callback)
  )();
};
...
Noble.prototype.onDiscover = function (
  uuid,
  address,
  addressType,
  connectable,
...
Noble.prototype.onServicesDiscovered = function (
  ...
  if (peripheral) {
    peripheral.emit('servicesDiscovered', peripheral, services, error);
  } // pass on to higher layers
};
...
Noble.prototype.onServicesDiscover = function (
  peripheralUuid,
  serviceUuids,
  error
) {
  ...
  if (peripheral) {
    ...
    this.emit(
      'warning',
      `unknown peripheral ${peripheralUuid} services discover!`
    );
  }
};

Noble.prototype.discoverIncludedServices = function (
  peripheralUuid,
  serviceUuid,
  serviceUuids
) {
  this._bindings.discoverIncludedServices(
    peripheralUuid,
    serviceUuid,
    serviceUuids
  );
...
Noble.prototype.onIncludedServicesDiscover = function (
  peripheralUuid,
  serviceUuid,
  ...
  if (service) {
    ...
    this.emit(
      'warning',
      `unknown peripheral ${peripheralUuid}, ${serviceUuid} included services discover!`
    );
  }
};

/// add characteristics to the peripheral; returns an array of initialized Characteristics objects
Noble.prototype.addCharacteristics = function (
  peripheralUuid,
  serviceUuid,
  characteristics
) {
  ...
  if (this._bindings.addCharacteristics) {
    this._bindings.addCharacteristics(
      peripheralUuid,
      serviceUuid,
      characteristics
    );
...
Noble.prototype.onCharacteristicsDiscovered = function (
  peripheralUuid,
  serviceUuid,
  characteristics,
  error
  ...
  service.emit('characteristicsDiscovered', characteristics, error);
};

Noble.prototype.discoverCharacteristics = function (
  peripheralUuid,
  serviceUuid,
  characteristicUuids
) {
  this._bindings.discoverCharacteristics(
    peripheralUuid,
    serviceUuid,
    characteristicUuids
  );
...
Noble.prototype.onCharacteristicsDiscover = function (
  peripheralUuid,
  serviceUuid,
  characteristics,
  error
...
Noble.prototype.onRead = function (
  peripheralUuid,
  serviceUuid,
  characteristicUuid,
  data,
...
Noble.prototype.write = function (
  peripheralUuid,
  serviceUuid,
  characteristicUuid,
  data,
...
Noble.prototype.onWrite = function (
  peripheralUuid,
  serviceUuid,
  characteristicUuid
) {
...
Noble.prototype.broadcast = function (
  peripheralUuid,
  serviceUuid,
  characteristicUuid,
  broadcast
) {
  this._bindings.broadcast(
    peripheralUuid,
    serviceUuid,
    characteristicUuid,
    broadcast
...
Noble.prototype.onBroadcast = function (
  peripheralUuid,
  serviceUuid,
  characteristicUuid,
  state
...
Noble.prototype.notify = function (
  peripheralUuid,
  serviceUuid,
  characteristicUuid,
  notify
) {
  this._bindings.notify(
    peripheralUuid,
    serviceUuid,
    characteristicUuid,
    notify
...
Noble.prototype.onNotify = function (
  peripheralUuid,
  serviceUuid,
  characteristicUuid,
  state
...
Noble.prototype.discoverDescriptors = function (
  peripheralUuid,
  serviceUuid,
  characteristicUuid
) {
  this._bindings.discoverDescriptors(
    peripheralUuid,
    serviceUuid,
    characteristicUuid
  );
...
Noble.prototype.onDescriptorsDiscover = function (
  peripheralUuid,
  serviceUuid,
  characteristicUuid,
  descriptors
...
Noble.prototype.readValue = function (
  peripheralUuid,
  serviceUuid,
  characteristicUuid,
  descriptorUuid
) {
  this._bindings.readValue(
    peripheralUuid,
    serviceUuid,
    characteristicUuid,
    descriptorUuid
...
Noble.prototype.onValueRead = function (
  peripheralUuid,
  serviceUuid,
  characteristicUuid,
  descriptorUuid,
...
Noble.prototype.writeValue = function (
  peripheralUuid,
  serviceUuid,
  characteristicUuid,
  descriptorUuid,
...
Noble.prototype.onValueWrite = function (
  peripheralUuid,
  serviceUuid,
  characteristicUuid,
  descriptorUuid
...
Noble.prototype.writeHandle = function (
  peripheralUuid,
  handle,
  data,
  withoutResponse
